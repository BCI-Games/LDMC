...
namespace BCI2000
{
    ...
    [Serializable]
    public class BCI2000EventDefinition: BCI2000ValueObjectDefinition {}
    [Serializable]
    public class BCI2000StateDefinition: BCI2000ValueObjectDefinition {}
    
    public class BCI2000ValueObjectDefinition
    {
        public string Name;
